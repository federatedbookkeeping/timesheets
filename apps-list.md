...
| [i4ware](https://www.freshworks.com/apps/freshdesk/i4ware_-_timesheet_for_freshdesk/) | Works with Freshdesk / Freshworks | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
| Intuit ([sample app, deprecated](https://github.com/IntuitDeveloper/SampleApp-TimeTracking_Invoicing-Java)) | See Quickbooks | N/A | N/A | N/A | N/A | N/A | N/A |
...
| [Ledger-CLI](https://www.ledger-cli.org/3.0/doc/ledger3.html#Time-Keeping) | See also "Plain Text Accounting" | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
| [Letnice](https://github.com/nomand/Letnice)| (from https://github.com/merveilles/Time-Travelers#time-travellers) | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
...
| [Log](https://avanier.vercel.app/tracker) | By Avanier, from https://github.com/merveilles/Time-Travelers#time-travellers) | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
| [Log](https://github.com/v-exec/Log) | By vi, from https://github.com/merveilles/Time-Travelers#time-travellers) | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
| [Log](https://github.com/maxdeviant/log) | By Marshall Bowers, from https://github.com/merveilles/Time-Travelers#time-travellers) | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
...
| [Nettime](https://www.nettimesolutions.com/) | See also Stratustime | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
...
| [Redmine Time Tracker](https://github.com/fernandokosh/redmine_time_tracker) | By Fernando Kosh, plugin for Redmine | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
...
| [Redmine Hourglass](https://github.com/hicknhack-software/redmine_hourglass) | Rewrite of Fernando Kosh's Redmine Time Tracker | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
...
| [Rubytime](https://github.com/LunarLogic/rubytime) | Merb-based time tracking and invoicing system | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
...
| [Simple Time Tracker (Minhyeok Lee)](https://apps.apple.com/nl/app/simple-timetracker-with-notion/id1590343222) | With Notion integration | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
...
| [Sprint App](https://github.com/macfanatic/SprintApp) | Deprecated | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
...
| [Stratustime](https://stratustime.centralservers.com/) | See also Paychex and Nettime | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
| [StreamDeck-Toggl](https://github.com/tobimori/streamdeck-toggl) | Toggl Track integration for Stream Deck | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
...
| [Taxi](https://github.com/sephii/taxi) | Multi-backend client that supports Zebra, Tempo, Tipee, Bexio and Clockify | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
...
| [Tempo](https://www.tempo.io/) | By Jira | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
...
| [Ticket Timer](https://www.freshworks.com/apps/freshdesk/ticket_timer/) ([Premium](https://www.freshworks.com/apps/freshdesk/ticket_timer_premium/)) | Works with Freshdesk / Freshworks | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
...
| [Timav](https://szymonkaliski.com/projects/timav/) ([repo](https://github.com/szymonkaliski/timav-standalone))| (from https://github.com/merveilles/Time-Travelers#time-travellers) | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) |
...
| [Timesheets](https://github.com/hardchor/timesheets) | By hardchor | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
| [Timesheets](https://play.google.com/store/apps/details?id=com.singlebyte.harvest) | By SingleByte | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
| Timesheets Time Tracker | See Veryfi | N/A | N/A | N/A | N/A | N/A | N/A |
...
| [TimeTracker](https://github.com/knewter/time-tracker) | By Knewter | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
| [Timetracker](https://github.com/anuko/timetracker) | By Anuko | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
| [Time Tracker](https://play.google.com/store/apps/details?id=com.cg.android.ebillitytimetracker) | By eBillity | (usable?) | (export formats) | (import formats) | (supports teams?) | (open source?) | price (US$/month) | 
